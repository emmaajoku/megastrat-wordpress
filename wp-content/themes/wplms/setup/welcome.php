		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						...
						<a href="https://wplms.io/support/knowledge-base/3-8-5/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
			...
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					...
					<div>
						<h4>Scorm Integration</h4>
						<p style="max-height: 320px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/data/uploads/new/scorm.png' ?>" alt="Scorm Integration">
						</p>
					...
					<div>
						<h4>New course featured block</h4>
						<p style="max-height: 320px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/data/uploads/new/course7.png' ?>" alt="course 7">
						</p>
			...
			<div class="changelog">
				<div class="feature-section col three-col">
					<div>
						...
						<p>WPLMS Push notifications addon is now live. Connect with your users anytime anywhere even when they're not browsing the internet.</p>
						<a href="https://wplms.io/downloads/wplms-push-notifications/" class="button" target="_blank">Download link</a>
					</div>
