    ...
    add_action('init',function(){
        ...
        if ( (in_array( 'vibe-customtypes/vibe-customtypes.php', apply_filters( 'active_plugins', $active_plugins ) ) || function_exists('is_plugin_active_for_network') && is_plugin_active_for_network( 'vibe-customtypes/vibe-customtypes.php')) && 
                ...
                (in_array( 'vibe-course-module/loader.php', apply_filters( 'active_plugins', $active_plugins ) ) || function_exists('is_plugin_active_for_network') && is_plugin_active_for_network( 'vibe-course-module/loader.php')) &&
                    ...
                    (in_array( 'bigbluebutton/bigbluebutton-plugin.php', apply_filters( 'active_plugins', $active_plugins ) ) || function_exists('is_plugin_active_for_network') && is_plugin_active_for_network( 'bigbluebutton/bigbluebutton-plugin.php')) &&
        ...
        if(!in_array( 'bigbluebutton/bigbluebutton-plugin.php', apply_filters( 'active_plugins',$active_plugins ) ) && !(function_exists('is_plugin_active_for_network') && is_plugin_active_for_network( 'bigbluebutton/bigbluebutton-plugin.php'))){
